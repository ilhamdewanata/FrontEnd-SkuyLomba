...
const NotFound = () => {
    return (
        <div className="h-full py-40 flex flex-col justify-center align-middle">
            <center className="mt-24 m-auto" >
                ...
                <div className=" tracking-widest mt-4">
                    ...
                    <span className="text-gray-500 text-xl">Maaf, halaman yang Anda cari tidak ditemukan</span>
